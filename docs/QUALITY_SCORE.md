...
| **Testing** | B | 359 tests / 27 files. Scrapers, hooks, components, utils covered. |
...
### High Priority
1. ~~**Testing coverage** (C → B): Add unit tests for scrapers, hooks, and API routes~~ ✅ Done — 359 tests / 27 files
