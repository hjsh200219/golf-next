...
function ChatIcon({ className }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M21.5 4.5a2 2 0 0 0-2-2h-15a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h5l4 4 4-4h2a2 2 0 0 0 2-2v-10z" />
    </svg>
  );
}
...
const NAV_ITEMS = [
  ...
  { href: '/chatbot', label: '챗봇', Icon: ChatIcon },
