...
const SITE_DESCRIPTION =
  '실시간 골프장 티타임 예약 조회 — 30개+ 골프장, 5분 간격 업데이트';
...
export function getWebApplicationSchema() {
  return {
    ...
    featureList:
      '실시간 티타임 조회 (5분 간격 업데이트), 날짜·시간대·가격 필터링, 경기북부·경기남부·강원·인천·충청 5개 권역, 골프장별 48시간 날씨 예보, 즐겨찾기 기능',
  };
}
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'GolfShin(골프신)은 한국 수도권 및 강원·충청 지역 30개 이상 골프장의 티타임 예약 가능 현황을 실시간으로 조회할 수 있는 무료 웹 서비스입니다. 5분 간격으로 데이터를 업데이트합니다.',
        },
      },
      {
        '@type': 'Question',
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: '각 골프장의 예약 시스템에서 5분 간격으로 데이터를 자동 수집하여, 거의 실시간에 가까운 티타임 정보를 제공합니다.',
        },
      },
    ],
  };
